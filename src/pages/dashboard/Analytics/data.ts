...
const viewsDetails: ViewsDetailTypes[] = [
  {
    page: "/Property-Booking/dashboard/ecommerce",
    bounce_rate: "87.5%",
  },
  {
    page: "/Property-Booking/dashboard/analytics",
    bounce_rate: "21.48%",
  },
  {
    page: "/Property-Booking/apps/calender",
    bounce_rate: "63.59%",
  },
  {
    page: "/Property-Booking/apps/email",
    bounce_rate: "7.12%",
  },
  {
    page: "/Property-Booking/custom/pages",
    bounce_rate: "86.46%",
  },
  {
    page: "/Property-Booking/components/ucharts",
    bounce_rate: "98.48%",
  },
  {
    page: "/Property-Booking/components/charts",
    bounce_rate: "23.79%",
  },
  {
    page: "/Property-Booking/components/tables",
    bounce_rate: "21.27%",
  },
];
