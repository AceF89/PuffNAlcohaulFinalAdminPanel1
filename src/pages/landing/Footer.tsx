      ...
      <Container>
        <Row className="justify-content-between">
          <Col md={6}>
            ...
            Property-Booking makes it easier to build better websites with
          ...
          <Col md={2}>
            ...
            <ul className="list-unstyled ps-0 mb-0 mt-3">
              ...
              <li className="mt-2">
                <Link
                  rel="noreferrer"
                  to={{ pathname: "http://Property-Booking-react.coderthemes.com/docs/" }}
                  target="_blank"
                  className="text-dark"
                >
                  Documentation
          ...
          <Col lg={12}>
            <div className="mt-5">
              <p className="mt-4 text-center mb-0">
                © {new Date().getFullYear()} Property-Booking. Design and coded by
                Coderthemes
              </p>
            </div>
          </Col>
